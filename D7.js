...
*/
function concatenateAndTransform(firstString, secondString) {
  let firstPart = firstString.substring(0, 2);
  let secondPart = secondString.slice(-3);
  let resultString = firstPart + secondPart;
  let uppercaseResult = resultString.toUpperCase();
  console.log(uppercaseResult);
}
let string1 = "EPICODE";
let string2 = "EDOCIPE";
concatenateAndTransform(string1, string2);
/* ESERCIZIO 2 (for)
  Scrivi una funzione che torni un array di 10 elementi; ognuno di essi deve essere un valore random compreso tra 0 e 100 (incluso).
*/
function generationArrayRandom() {
  let arrayRandom = [];
  for (let i = 0; i < 10; i++) {
...
let result = generationArrayRandom();
console.log(result);

/* ESERCIZIO 3 (filter)
  Scrivi una funzione per ricavare solamente i valori PARI da un array composto da soli valori numerici
*/
const arrayOfNumber = [1, 20, 35, 45, 90];
const numberEven = function (arrayOfNumber) {
  const allNumbersEven = arrayOfNumber.filter((num) => {
    return num % 2 === 0;
  });
  console.log(allNumbersEven);
};
numberEven(arrayOfNumber);
/* ESERCIZIO 4 (forEach)
  Scrivi una funzione per sommare i numeri contenuti in un array
*/
const sumOfNumber = function (arrayOfNumber) {
  let total = 0;
...
sumOfNumber(arrayOfNumber);
/* ESERCIZIO 5 (reduce)
  Scrivi una funzione per sommare i numeri contenuti in un array
*/
const sum = arrayOfNumber.reduce((acc, current) => {
  return acc + current;
}, 0);
console.log(sum);
/* ESERCIZIO 6 (map)
...
*/
const sumOfNumbersn = arrayOfNumber.map((number) => {
  return number + 1;
});
console.log(sumOfNumbersn);
/* ESERCIZIO 7 (map)
...
const lenghtOfArray = giganti.map((gig) => {
  return gig.length;
});
...
let oddNumbersArray = createOddArray();
